...
void RenderFunction(void)
{
	...
	// DESENAREA PUNCTELOR
	glEnable(GL_POINT_SMOOTH);		  //  Activarea atributului GL_POINT_SMOOTH netezeste marginile punctelor;
	glPointSize(20.0);				  //  Se seteaza dimensiunea punctelor;

	// Cerinta 1: Se coloreaza diferit punctele atribuind variabilei uniforme codCol valori diferite de la 1 la 6
	/*codCol = 1;
	...
	// (CERINTA SUPLIMENTARA) - TOATE PUNCTELE AU ACEEASI CULOARE GENERATA ALEATOR
	//	Se atribuie o valoare random intre 0 si 7 variabilei uniforme; 
	srand(time(NULL));
	codCol = rand() % 8;
	glUniform1i(codColLocation, codCol);
