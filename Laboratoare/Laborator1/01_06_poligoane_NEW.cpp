...
void CreateVBO(void)
{
    ...
    GLfloat Vertices[] = {
        ...
        -0.95f,  -0.6f, 0.0f, 1.0f, // stanga jos
        -0.95f,  -0.1f, 0.0f, 1.0f, // stanga sus
        -0.65f,  -0.1f, 0.0f, 1.0f, // dreapta sus
        -0.65f,  -0.6f, 0.0f, 1.0f, // dreapta jos

        // poligonul rosu
         -1.0f,  -1.0f, 0.0f, 1.0f, // stanga jos
         -0.6f, -0.16f, 0.0f, 1.0f, // sus
         -0.5f, -0.65f, 0.0f, 1.0f, // dreapta
        -0.75f, -0.95f, 0.0f, 1.0f, // mijloc jos

        // poligonul rosu mai deschis
        -0.35f, -0.13f, 0.0f, 1.0f, // mijloc jos
        -0.85f, -0.13f, 0.0f, 1.0f, // stanga
        -0.48f,  0.05f, 0.0f, 1.0f, // mijloc sus
        -0.25f,  0.45f, 0.0f, 1.0f, // sus
         -0.1f, -0.45f, 0.0f, 1.0f, // dreapta jos
        
        // poligonul galben din dreapta
         0.65f, -0.13f, 0.0f, 1.0f, // mijloc
          0.2f, -0.13f, 0.0f, 1.0f, // stanga
          0.7f,  0.45f, 0.0f, 1.0f, // sus
          0.9f, -0.45f, 0.0f, 1.0f // dreapta jos
    };
...
int main(int argc, char* argv[])
{
    ...
    glutCreateWindow("Poligoane - OpenGL <<nou>>");   //	 Creeaza fereastra de vizualizare, indicand numele acesteia;
