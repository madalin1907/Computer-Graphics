...
void CreateVBO(void)
{
    ...
    GLfloat Vertices[] = {
        -0.85f, -0.83f, 0.0f, 1.0f,
        - 0.8f, -0.75f, 0.0f, 1.0f,
...
int main(int argc, char* argv[])
{
    ...
    glutCreateWindow("Puncte segmente - OpenGL <<nou>>");   //	 Creeaza fereastra de vizualizare, indicand numele acesteia;
