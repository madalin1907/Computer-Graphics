...
// ================================================
// |       Laboratorul VIII - 08_07_con.cpp       |
// ================================================
// 
//	Biblioteci
...
const int NR_MERIDIANE_CON = 25, RAZA_CON = 50, INALTIME_CON = 130;
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("Desenarea unui con");		//	Creeaza fereastra de vizualizare, indicand numele acesteia;
