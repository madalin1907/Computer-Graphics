...
void main(void)
  {
    ...
    vec3 ambient_light = ambientStrength * vec3(1.0, 1.0, 1.0);          //  ambient_light=ambientStrength*lightColor; 
    ...
    vec3 diffuse_light = vec3(1.0f, 1.0f, 1.0f);                            //  diffuse_light=lightColor;
    vec3 diffuse_term = diff * diffuse_light * objectColor;     //  diffuse_material=objectColor;
    
    //  Specular;
    float specularStrength = 15.0f;
