...
{
	ProgramIdv = LoadShaders("10_04v_Shader.vert", "10_04v_Shader.frag");
	glUseProgram(ProgramIdv);
}

void CreateShadersFragment(void)
{
	ProgramIdf = LoadShaders("10_04f_Shader.vert", "10_04f_Shader.frag");
...
void RenderFunction(void)
{
	...
	glUniform3f(lightPosLoc, 0.0f, -185.0f, 0.0f);
