...
// =================================================
// |   Curs VII - 07_04_randare_instantiata.cpp    |
// =================================================
// 
// 
//	Biblioteci
...
float width = 1200, height = 750, zNear = 1, fovdeg = 90;
...
void CreateVBO(void)
{
	...
	for (int i = 0; i < INSTANCE_COUNT; ++i)
	{
		...
		float z = i * 10.0f;						  // Deplasarea pe OZ;
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("Cerinta2");			//	Creeaza fereastra de vizualizare, indicand numele acesteia;
