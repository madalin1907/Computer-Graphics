...
float const PI = 3.141592;															//	Valoarea lui pi;

float refX = 0.0f, refY = 0.0f, refZ = 0.0f,										//	Elemente pentru matricea de vizualizare;
	  obsX, obsY, obsZ,
	  vX = 0.0f, vY = 0.0f, vZ = 1.0f;

float alpha = 0.0f, beta = 0.0f, dist = 200.0f,										//	Elemente pentru deplasarea pe sfera;
	  incrAlpha1 = 0.01, incrAlpha2 = 0.01;

float																				//	Elemente pentru matricea de proiectie;
